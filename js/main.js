...
// change backgrounf header
function scrollHeader(){
    const header = document.getElementById('header')

    // When the scroll is > 80 vh, add the scroll-header class to the header tag
...
// show scrollup (scroll to top button) 
function scrollUp(){
    const scrollUp = document.getElementById('scroll-up');
    // When the scroll is > 400 vh, add the show-scroll class to the a tag with the scroll-top class
